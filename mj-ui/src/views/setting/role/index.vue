...
<!--				<el-button type="primary" plain :disabled="selection.length!=1" @click="permission">权限设置</el-button>-->
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="apiObj" row-key="id" @selection-change="selectionChange" stripe>
				...
				<el-table-column label="创建时间" prop="createdAt" width="180"></el-table-column>
				<el-table-column label="操作" fixed="right" align="right" width="350">
					<template #default="scope">
						...
						<el-button plain type="primary" size="small" @click="userBind(scope.row, scope.$index)">
							用户绑定
						</el-button>
						<el-button plain type="primary" size="small" @click="permission(scope.row)">
							赋权
						</el-button>
