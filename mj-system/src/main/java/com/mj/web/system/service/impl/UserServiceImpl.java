...
@Service
@Transactional
public class UserServiceImpl extends AbstractService<UserMapper, UserDO, UserDTO> implements UserService {
    @Autowired
    ...
    public UserDTO insert(UserDTO entity) {
        ...
        if (count(new LambdaQueryWrapper<UserDO>().eq(UserDO::getUsername, entity.getUsername())) > 0) {
