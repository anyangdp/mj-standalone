package com.mj.activiti.service;
...
public interface IProcessDefinitionService {
     ...
     * @return Page 分页信息
     */
     IPage<ProcessDefinitionDTO> selectProcessDefinitionList(ProcessDefinitionDTO processDefinition, Integer page, Integer pageSize);
