...
public class CodeGenerator {
   ...
   public static String jdbcTablePrefix = "bd_";//表名前缀

    public static String childFolder = "mj-big-data/";
     ...
     * 生成的文件存放的包，公共基础包
     */
    public static String packageBase = "com.mj.web.big.data";
    ...
    public static void main(String[] args) throws PropertyVetoException {
        ...
        for (Map<String, Object> m : l) {
            ...
            List<Map<String, Object>> fields = jdbcTemplate.queryForList("show full fields from " + tableName);
