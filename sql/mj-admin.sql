...
INSERT INTO `s_permission` (`id`, `name`, `show_always`, `level`, `type`, `title`, `path`, `icon`, `http_method`, `parent_id`, `description`, `sort`, `created_by`, `created_at`, `updated_by`, `updated_at`, `active`, `deleted`, `deleted_by`, `deleted_at`, `deleted_msg`) VALUES ('device', '设备', 0, 2, 0, '设备', '', NULL, NULL, 'device-manage', NULL, 1, NULL, '2023-02-06 09:58:18', NULL, '2023-02-06 15:08:54', 1, 0, NULL, NULL, NULL);
INSERT INTO `s_permission` (`id`, `name`, `show_always`, `level`, `type`, `title`, `path`, `icon`, `http_method`, `parent_id`, `description`, `sort`, `created_by`, `created_at`, `updated_by`, `updated_at`, `active`, `deleted`, `deleted_by`, `deleted_at`, `deleted_msg`) VALUES ('device-access', '设备接入目录', 0, 1, 1, '设备接入', '', NULL, NULL, '', NULL, 80, NULL, '2023-02-06 09:56:20', NULL, '2023-02-06 16:20:46', 1, 0, NULL, NULL, NULL);
INSERT INTO `s_permission` (`id`, `name`, `show_always`, `level`, `type`, `title`, `path`, `icon`, `http_method`, `parent_id`, `description`, `sort`, `created_by`, `created_at`, `updated_by`, `updated_at`, `active`, `deleted`, `deleted_by`, `deleted_at`, `deleted_msg`) VALUES ('device-manage', '设备管理目录', 0, 1, 1, '设备管理', '', NULL, NULL, '', NULL, 90, NULL, '2023-02-06 09:55:24', NULL, '2023-02-06 16:04:01', 1, 0, NULL, NULL, NULL);
...
INSERT INTO `s_permission` (`id`, `name`, `show_always`, `level`, `type`, `title`, `path`, `icon`, `http_method`, `parent_id`, `description`, `sort`, `created_by`, `created_at`, `updated_by`, `updated_at`, `active`, `deleted`, `deleted_by`, `deleted_at`, `deleted_msg`) VALUES ('network', '网络组件', 0, 2, 0, '网络组件', '', NULL, NULL, 'device-access', NULL, 1, NULL, '2023-02-06 09:58:44', NULL, '2023-02-06 15:08:54', 1, 0, NULL, NULL, NULL);
...
INSERT INTO `s_permission` (`id`, `name`, `show_always`, `level`, `type`, `title`, `path`, `icon`, `http_method`, `parent_id`, `description`, `sort`, `created_by`, `created_at`, `updated_by`, `updated_at`, `active`, `deleted`, `deleted_by`, `deleted_at`, `deleted_msg`) VALUES ('product', '产品', 0, 2, 0, '产品', '', '', NULL, 'device-manage', NULL, 1, NULL, '2023-02-06 09:58:06', NULL, '2023-02-06 15:08:54', 1, 0, NULL, NULL, NULL);
INSERT INTO `s_permission` (`id`, `name`, `show_always`, `level`, `type`, `title`, `path`, `icon`, `http_method`, `parent_id`, `description`, `sort`, `created_by`, `created_at`, `updated_by`, `updated_at`, `active`, `deleted`, `deleted_by`, `deleted_at`, `deleted_msg`) VALUES ('protocol', '协议', 0, 2, 0, '协议', '', NULL, NULL, 'device-access', NULL, 1, NULL, '2023-02-06 09:58:58', NULL, '2023-02-06 15:08:54', 1, 0, NULL, NULL, NULL);
